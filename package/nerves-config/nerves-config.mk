...
define NERVES_CONFIG_INSTALL_TARGET_CMDS
	cp -f $(NERVES_CONFIG_PKGDIR)/echo-gcc-args $(HOST_DIR)/opt/ext-toolchain/bin/echo-gcc-args
	cp -f $(NERVES_CONFIG_PKGDIR)/echo-gcc-args $(HOST_DIR)/opt/ext-toolchain/bin/echo-gcc-args$(TOOLCHAIN_EXTERNAL_SUFFIX)
